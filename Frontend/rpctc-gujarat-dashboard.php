<?php
// rpctc_gujarat_dashboard.php
session_start();

// Check if RPCTC admin is logged in
if (!isset($_SESSION['rpctc_logged_in']) || $_SESSION['rpctc_center'] !== 'Gujarat') {
...
$stmt = $conn->prepare("SELECT * FROM rpctc_admin_credentials WHERE center = 'Gujarat' AND rpctc_username = ?");
...
<head>
    ...
    <title>RPCTC Gujarat Dashboard - NCRB Training Portal</title>
    <!-- Favicon links -->
...
<body>
    ...
    <div class="fixed-header">
        ...
        <div class="nav-container">
            <div class="nav-content">
                <div class="nav-title">RPCTC Gujarat - Admin Dashboard</div>
    ...
    <div class="dashboard">
        ...
        <div class="welcome-banner">
            <h2>RPCTC Gujarat - Training Management</h2>
            <p>Welcome, <strong><?php echo $username; ?></strong>. Manage all aspects of the Gujarat RPCTC training portal.</p>
        </div>
