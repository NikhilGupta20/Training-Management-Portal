...
<head>
    ...
    <title>Training Portal | RPCTC Gujarat</title>
    <!-- Favicon links -->
...
<body>
            ...
            <div class="nav-content">
                ...
                <div class="login-links">
                    <div class="admin-login">
                        <a href="rpctc-gujarat-admin-login.php"><i class="fas fa-lock"></i> Admin Login</a>
                    </div>
    ...
    <div class="dashboard">
        ...
        <div class="welcome-banner">
            ...
            <h2>Welcome to RPCTC Gujarat Training Management System</h2>
        </div>
