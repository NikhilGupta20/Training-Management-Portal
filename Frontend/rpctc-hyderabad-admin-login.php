...
<head>
    ...
    <title>Admin Login | RPCTC Hyderabad</title>
    <!-- Favicon links -->
    ...
    <div class="fixed-header">
        ...
        <div class="nav-container">
            <div class="nav-content">
                <div class="nav-title">RPCTC Hyderabad</div>
                <!-- Back to Dashboard Button -->
                <div class="admin-login">
                    <a href="rpctc-hyderabad-home-page.php"><i class="fas fa-arrow-left"></i> Back to Dashboard</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="login-container">
            ...
            <div class="login-card">
                ...
                <div class="login-header">
                    <i class="fas fa-lock"></i> RPCTC Hyderabad Authentication
                </div>
                <div class="login-body">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" class="login-btn">
                            <i class="fas fa-sign-in-alt"></i> Login to RPCTC Hyderabad Dashboard
                        </button>
                    </form>
                </div>
            </div>
