<?php
// rpctc_lucknow_dashboard.php
session_start();

// Check if RPCTC admin is logged in
if (!isset($_SESSION['rpctc_logged_in']) || $_SESSION['rpctc_center'] !== 'Lucknow') {
...
$stmt = $conn->prepare("SELECT * FROM rpctc_admin_credentials WHERE center = 'Lucknow' AND rpctc_username = ?");
...
<head>
    ...
    <title>RPCTC Lucknow Dashboard - NCRB Training Portal</title>
    <!-- Favicon links -->
...
<body>
    ...
    <div class="fixed-header">
        ...
        <div class="nav-container">
            <div class="nav-content">
                <div class="nav-title">RPCTC Lucknow - Admin Dashboard</div>
    ...
    <div class="dashboard">
        ...
        <div class="welcome-banner">
            <h2>RPCTC Lucknow - Training Management</h2>
            <p>Welcome, <strong><?php echo $username; ?></strong>. Manage all aspects of the Lucknow RPCTC training portal.</p>
        </div>
        
        <!-- Action Buttons - Reorganized as per requirements -->
        <div class="action-grid">
            <!-- 1. Training Programs -->
            <a href="rpctc-lucknow-admin-calendar.php" class="action-button">
