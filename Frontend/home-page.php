...
<head>
    ...
    <title>Training Portal | NCRB</title>
    <!-- Favicon links -->
    ...
    <style>
        ...
        * {
        ...
        /* RPCTC Dropdown Styles */
        .rpctc-dropdown {
            position: relative;
            display: inline-block;
        }

        .rpctc-dropdown-content {
            display: none;
            position: absolute;
        ...
        .rpctc-dropdown-content a:last-child {
            border-bottom: none;
        }

        .rpctc-dropdown-content a:hover {
            background: var(--secondary);
            color: var(--white);
        }

        .rpctc-dropdown:hover .rpctc-dropdown-content {
            display: block;
        }

        .rpctc-dropdown .dropdown-icon {
            margin-left: 8px;
            font-size: 0.8rem;
            transition: var(--transition);
        }

        .rpctc-dropdown:hover .dropdown-icon {
        ...
        @media (max-width: 576px) {
            ...
            /* RPCTC dropdown adjustments for mobile */
            .rpctc-dropdown-content {
                min-width: 180px;
                left: 50%;
...
<body>
        ...
        <div class="nav-container">
            <div class="nav-content">
                ...
                <div class="login-links">
                    <!-- RPCTC Dropdown -->
                    <div class="admin-login rpctc-dropdown">
                        <a href="#" class="dropbtn">RPCTC <i class="fas fa-caret-down dropdown-icon"></i></a>
                        <div class="rpctc-dropdown-content">
                            <a href="rpctc-lucknow-home-page.php">RPCTC Lucknow</a>
                            <a href="rpctc-kolkata-home-page.php">RPCTC Kolkata</a>
                            <a href="rpctc-hyderabad-home-page.php">RPCTC Hyderabad</a>
                            <a href="rpctc-gujarat-home-page.php">RPCTC Gujarat</a>
                        </div>
                    </div>
                    
                    <div class="separator">|</div>
                    <div class="admin-login rpctc-dropdown">
                        <a href="#" class="dropbtn">Login <i class="fas fa-caret-down dropdown-icon"></i></a>                        
                        <div class="rpctc-dropdown-content">
    ...
    <div class="dashboard">
        ...
        <div class="welcome-banner">
            ...
            <h2>Welcome to NCRB Training Management System</h2>
        </div>
