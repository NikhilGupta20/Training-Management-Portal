...
<head>
    ...
    <title>Admin Login | RPCTC Lucknow</title>
    <!-- Favicon links -->
        ...
        <div class="nav-container">
            <div class="nav-content">
                ...
                <div class="admin-login">
                    <a href="rpctc-lucknow-home-page.php"><i class="fas fa-arrow-left"></i> Back to Dashboard</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="login-container">
            ...
            <div class="login-card">
                ...
                <div class="login-header">
                    <i class="fas fa-lock"></i> RPCTC Lucknow Authentication
                </div>
                <div class="login-body">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" class="login-btn">
                            <i class="fas fa-sign-in-alt"></i> Login to RPCTC Lucknow Dashboard
                        </button>
                    </form>
                </div>
            </div>
