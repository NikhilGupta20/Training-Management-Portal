<?php
// rpctc_kolkata_dashboard.php
session_start();

// Check if RPCTC admin is logged in
if (!isset($_SESSION['rpctc_logged_in']) || $_SESSION['rpctc_center'] !== 'Kolkata') {
...
$stmt = $conn->prepare("SELECT * FROM rpctc_admin_credentials WHERE center = 'Kolkata' AND rpctc_username = ?");
...
<head>
    ...
    <title>RPCTC Kolkata Dashboard - NCRB Training Portal</title>
    <!-- Favicon links -->
...
<body>
    ...
    <div class="fixed-header">
        ...
        <div class="nav-container">
            <div class="nav-content">
                <div class="nav-title">RPCTC Kolkata - Admin Dashboard</div>
    ...
    <div class="dashboard">
        ...
        <div class="welcome-banner">
            <h2>RPCTC Kolkata - Training Management</h2>
            <p>Welcome, <strong><?php echo $username; ?></strong>. Manage all aspects of the Kolkata RPCTC training portal.</p>
        </div>
