...
<head>
    ...
    <title>Admin Dashboard - NCRB Training Portal</title>
    <!-- Favicon links -->
...
<body>
    ...
    <div class="dashboard">
        ...
        <div class="welcome-banner">
            ...
            <p>Welcome, <strong><?php echo $username; ?></strong>. Manage all aspects of the training portal from this central dashboard.</p>
        </div>
        
        <!-- Action Buttons - Reorganized as per requirements -->
        <div class="action-grid">
            <!-- 1. Portal Feedback -->
            <a href="admin-portal-feedback.php" class="action-button">
                <div class="button-icon"><i class="fas fa-comments"></i></div>
                <div class="button-title">Portal Feedback</div>
                <div class="button-description">Collect and review user feedback on portal</div>
            </a>
            ...
            <!-- 8. Budget Management -->
            <a href="admin-budget.php" class="action-button">
                <div class="button-icon"><i class="fas fa-hand-holding-usd"></i></div>
                <div class="button-title">Budget Management</div>
                <div class="button-description">Track and manage training budgets</div>
            </a>
            ...
            <!-- 12. AIBE Examination -->
            <a href="admin-aibe-examination.php" class="action-button">
                <div class="button-icon"><i class="fas fa-graduation-cap"></i></div>
                <div class="button-title">AIBE Examination</div>
                <div class="button-description">Manage marks, certificates and admit cards</div>
            </a>
            
            <!-- 13. AIBE Examination Reappear -->
            <a href="admin-aibe-reappear.php" class="action-button">
                <div class="button-icon"><i class="fas fa-redo"></i></div>
                <div class="button-title">AIBE Examination Reappear</div>
                <div class="button-description">Manage reappear candidates and results</div>
            </a>
            
            <!-- 14. RPCTC Admin Management -->
            <a href="admin-rpctc-management.php" class="action-button">
                <div class="button-icon"><i class="fas fa-user-cog"></i></div>
                <div class="button-title">RPCTC Admin Management</div>
                <div class="button-description">Create credentials for RPCTC organizations</div>
            </a>
        </div>
    </div>
