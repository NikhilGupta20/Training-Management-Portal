...
<head>
    ...
    <title>Admin Login | RPCTC Gujarat</title>
    <!-- Favicon links -->
    ...
    <div class="fixed-header">
        ...
        <div class="nav-container">
            <div class="nav-content">
                <div class="nav-title">RPCTC Gujarat</div>
                <!-- Back to Dashboard Button -->
                <div class="admin-login">
                    <a href="rpctc-gujarat-home-page.php"><i class="fas fa-arrow-left"></i> Back to Dashboard</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="login-container">
            ...
            <div class="login-card">
                ...
                <div class="login-header">
                    <i class="fas fa-lock"></i> RPCTC Gujarat Authentication
                </div>
                <div class="login-body">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" class="login-btn">
                            <i class="fas fa-sign-in-alt"></i> Login to RPCTC Gujarat Dashboard
                        </button>
                    </form>
                </div>
            </div>
